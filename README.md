...
Люблю доводить проект до состояния, когда им реально пользуются: не просто обучить модель в ноутбуке, а собрать базу, API и интерфейс, упаковать в Docker и выкатить на сервер. Дипломный портал я сам развернул в инфраструктуре вуза во время практики, а не оставил «работающим на ноутбуке».

- 🎯 **Ищу:** первую постоянную работу — Junior Backend / Python / ML
- 🧩 **Основной стек:** Python, Django, FastAPI, PostgreSQL, Docker, Nginx, Gunicorn
- 🧠 **Сейчас копаю:** PyTorch, инференс в проде, проектирование API
- 🌍 **Формат:** Москва, удалёнка или гибрид
...
### Открыт к предложениям — напишите, обсудим
